...
export async function GET(request) {
    try {
        ...
        // Calculate date range - explicitly include today
        ...
        // Generate array of all dates in range (ensuring today is included)
        const dateRange = []
        ...
        const salesByDate = {}
        sales.forEach(sale => {
            // Format date consistently using UTC to avoid timezone issues
        ...
        const dailyData = dateRange.map(date => {
            // Ensure consistent date string format with UTC
