        ...
        <div className="overflow-hidden">
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <Link
                href="/inventory/new"
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-xl shadow-md hover:shadow-xl transition-all duration-200"
              >
                <Plus className="h-5 w-5 mr-2" />
                Add First Item
              </Link>
